...
Ported from the Support Fins website (web/sway.js, web/planes.js, web/inside.js on
the `sway-braces` branch of MitchMilam/support-fins). Where this port and sway.js
disagree, sway.js is the reference.
